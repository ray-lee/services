...
INSERT INTO id_generators
  ...
  SELECT
     'a19171fa-c33f-46cb-a952-0a112f076736',
     'Transport Number',
     'A unique number that identifies a transport.',
     '9',
     '',
'<org.collectionspace.services.id.SettableIDGenerator>
   <parts>
    <org.collectionspace.services.id.StringIDGeneratorPart>
      <initialValue>TRA</initialValue>
      <currentValue>TRA</currentValue>
    </org.collectionspace.services.id.StringIDGeneratorPart>
  ...
  WHERE 'a19171fa-c33f-46cb-a952-0a112f076736' NOT IN
        (
        SELECT  csid
        FROM    id_generators
        );
