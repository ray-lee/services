...
--
-- Name: updateculturehierarchytable(); Type: FUNCTION; Schema: utils; Owner: nuxeo_pahma
-- Maintained by PAHMA Hierarchies scripts:
-- https://github.com/cspace-deployment/Tools/tree/master/scripts/pahma/hierarchies
--

CREATE FUNCTION utils.updateculturehierarchytable() RETURNS bigint
    LANGUAGE plpgsql
    AS $$
DECLARE
  ph text;
...
ALTER FUNCTION utils.updateculturehierarchytable() OWNER TO nuxeo_pahma;
