...
--
-- Name: get_updatedat_co_mh(character varying); Type: FUNCTION; Schema: utils; Owner: nuxeo_bampfa
--

CREATE FUNCTION utils.get_updatedat_co_mh(objcsid character varying) RETURNS timestamp without time zone
...
ALTER FUNCTION utils.get_updatedat_co_mh(objcsid character varying) OWNER TO nuxeo_bampfa;
