...
--
-- Name: concat_artists(character varying); Type: FUNCTION; Schema: utils; Owner: nuxeo_bampfa
--

CREATE FUNCTION utils.concat_artists(csid character varying) RETURNS character varying
...
ALTER FUNCTION utils.concat_artists(csid character varying) OWNER TO nuxeo_bampfa;
