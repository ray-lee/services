...
--
-- Name: get_originaljpeg_filepath(character varying); Type: FUNCTION; Schema: utils; Owner: nuxeo_bampfa
--

CREATE FUNCTION utils.get_originaljpeg_filepath(title character varying) RETURNS character varying
...
from collectionobjects_common co
   ...
   JOIN view v ON (hv.id = v.id AND v.tag='originalJpeg')
...
ALTER FUNCTION utils.get_originaljpeg_filepath(title character varying) OWNER TO nuxeo_bampfa;
